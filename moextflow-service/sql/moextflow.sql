...
CREATE TABLE `t_todo_task` (
  ...
  `apply_user_code` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '发起人用户名',
  `apply_user_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '发起人姓名',
  `receive_user_code` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '接收人用户编码',
  `receive_user_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '接收人姓名',
  `status` varchar(10) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '待办：TODO；已办：DOING；办结：DONE',
  `process_instance_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '工作流流程实例ID',
  `task_name` varchar(256) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '任务名',
  `task_id` varchar(64) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '工作流则任务ID',
  `task_create_time` datetime NOT NULL COMMENT '任务创建时间',
  `task_receive_time` datetime DEFAULT NULL COMMENT '任务接收时间',
  `task_complete_time` datetime DEFAULT NULL COMMENT '任务完成时间',
  `todo_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '待办ID',
  `form_instance_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '表单实例ID',
  `step_node_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL COMMENT '节点名称',
  ...
  PRIMARY KEY (`id`),
  KEY `idx_receive_user_code` (`receive_user_code`,`status`) USING BTREE,
  KEY `idx_create_time` (`create_time`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_bin COMMENT='工作流待办表';
...
CREATE TABLE `t_task_comment` (
  ...
  `task_receive_time` datetime DEFAULT NULL COMMENT '任务接收时间',
  `todo_id` varchar(50) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '待办ID',
  `user_code` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '接收人用户编码',
  `user_name` varchar(32) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL COMMENT '接收人姓名',
  `is_del` tinyint(1) NOT NULL DEFAULT '0' COMMENT '删除标识',
  `oper_type` varchar(10) COLLATE utf8mb4_bin DEFAULT NULL COMMENT '操作类型：申请=0，通过=1，退回=2，否决=3，跳转=4，签收=5，重新申请=6，销毁申请=7',
  `create_time` datetime NOT NULL COMMENT '创建时间',
  `update_time` datetime NOT NULL ON UPDATE CURRENT_TIMESTAMP COMMENT '最后更新时间',
  PRIMARY KEY (`id`),
  KEY `idx_create_time` (`create_time`) USING BTREE,
