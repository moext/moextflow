 ...
 */
package com.moext.flowservice.modeler.ui.modeler.model;

import java.util.Date;

import com.moext.flowservice.modeler.ui.common.model.AbstractRepresentation;
...
public class ModelRepresentation extends AbstractRepresentation {
	...
	public void initialize(AbstractModel model) {
		...
		// When based on a ProcessModel and not history, this is always the latest
		// version
	...
	/**
	 * Update all editable properties of the given {@link Model} based on the values
	 * in this instance.
	 */
