...
public class TodoTask implements Serializable {
	...
	public boolean equals(Object that) {
		...
		return (this.getId() == null ? other.getId() == null : this.getId().equals(other.getId()))
				&& (this.getApplyUserCode() == null ? other.getApplyUserCode() == null
						: this.getApplyUserCode().equals(other.getApplyUserCode()))
				&& (this.getApplyUserName() == null ? other.getApplyUserName() == null
						: this.getApplyUserName().equals(other.getApplyUserName()))
				&& (this.getReceiveUserCode() == null ? other.getReceiveUserCode() == null
						: this.getReceiveUserCode().equals(other.getReceiveUserCode()))
				&& (this.getReceiveUserName() == null ? other.getReceiveUserName() == null
						: this.getReceiveUserName().equals(other.getReceiveUserName()))
				&& (this.getStatus() == null ? other.getStatus() == null : this.getStatus().equals(other.getStatus()))
				&& (this.getProcessInstanceId() == null ? other.getProcessInstanceId() == null
						: this.getProcessInstanceId().equals(other.getProcessInstanceId()))
				&& (this.getTaskName() == null ? other.getTaskName() == null
						: this.getTaskName().equals(other.getTaskName()))
				&& (this.getTaskId() == null ? other.getTaskId() == null : this.getTaskId().equals(other.getTaskId()))
				&& (this.getTaskCreateTime() == null ? other.getTaskCreateTime() == null
						: this.getTaskCreateTime().equals(other.getTaskCreateTime()))
				&& (this.getTaskReceiveTime() == null ? other.getTaskReceiveTime() == null
						: this.getTaskReceiveTime().equals(other.getTaskReceiveTime()))
				&& (this.getTaskCompleteTime() == null ? other.getTaskCompleteTime() == null
						: this.getTaskCompleteTime().equals(other.getTaskCompleteTime()))
				&& (this.getTodoId() == null ? other.getTodoId() == null : this.getTodoId().equals(other.getTodoId()))
				&& (this.getFormInstanceId() == null ? other.getFormInstanceId() == null
						: this.getFormInstanceId().equals(other.getFormInstanceId()))
				&& (this.getStepNodeName() == null ? other.getStepNodeName() == null
						: this.getStepNodeName().equals(other.getStepNodeName()))
				&& (this.getIsDel() == null ? other.getIsDel() == null : this.getIsDel().equals(other.getIsDel()))
				&& (this.getProcDefKey() == null ? other.getProcDefKey() == null
						: this.getProcDefKey().equals(other.getProcDefKey()))
